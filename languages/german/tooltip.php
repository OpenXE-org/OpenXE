...
$tooltip['firmendaten']['edit']['herstellerimdokument']="Falls ein Hersteller im Artikel hinterlegt ist, wird dieser in der Positionstabelle auf dem Beleg mit abgebildet.<br><br>Beispiel: 'Hersteller: Schrauben Meier'<br><br>Aktuell in Angebot, Auftrag, Rechnung, Lieferschein, Bestellung, Gutschrift.";
