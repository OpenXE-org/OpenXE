...
class Shopimporter_Woocommerce extends ShopimporterBase
{
  ...
  public function getKonfig($shopid, $data)
  {
    ...
    $this->protokoll = $preferences['felder']['protokoll'] ?? null;
    $this->ssl_ignore = $preferences['felder']['ssl_ignore'] ?? null;
    $ImportWooCommerceApiSecret = $preferences['felder']['ImportWoocommerceApiSecret'] ?? null;
    $ImportWooCommerceApiKey = $preferences['felder']['ImportWoocommerceApiKey'] ?? null;
    $ImportWooCommerceApiUrl = $preferences['felder']['ImportWoocommerceApiUrl'] ?? null;

    $this->statusPending = $preferences['felder']['statusPending'] ?? null;
    $this->statusProcessing = $preferences['felder']['statusProcessing'] ?? null;
    $this->statusCompleted = $preferences['felder']['statusCompleted'] ?? null;

    $this->priceType = $preferences['felder']['priceType'] ?? null;
