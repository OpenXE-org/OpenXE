  ...
  <table class="tableborder" border="0" cellpadding="3" cellspacing="0" width="100%">
    <tbody>
      <tr classname="orange1" class="orange1" bordercolor="" align="" bgcolor="" height="" valign="">
        <td colspan="4" bordercolor="" class="" align="" bgcolor="" height="" valign="">Auftrag (Freigabe)<br></td>
      </tr>
    ...
    <input type="submit" name="freigabe"
    value="Freigabe" /> <input type="button" value="Abbrechen" /></td>
    </tr>
