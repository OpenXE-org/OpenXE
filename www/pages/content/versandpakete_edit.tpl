            			...
            			<div class="inside inside-full-height">
            				<fieldset>
                                ...
                                <table width="100%" border="0" class="mkTableFormular">
                                    ...
                                    <tr [PAKETSCHEINDRUCKEN_HIDDEN]><td><button name="submit" value="paketscheinetikettendrucken" class="ui-button-icon" style="width:100%;">Positionenetiketten drucken</button></td></tr>
