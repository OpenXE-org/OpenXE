<fieldset data-filter="bestellung" class="table_filter" style="display:none">
	...
	<table width="100%">
				...
				<div class="table_filter_container table_filter_container_left">
					<table>
						<tr>
							...
							<td><input type="text" name="lieferantennummer" value="" id="lieferantennummer"></td>
						</tr>
						<tr>
							<td>Name:</td>
			...
			<td valign="top">
				...
				<div class="table_filter_container table_filter_container_right">
					<table width="100%">
						...
						<tr>
							<td>Belegnummer:</td>
							<td><input type="text" name="belegnummer" value="" id="bestellungnummer"></td>
						</tr>
						<tr>
							<td>Freitext:</td>
		...
		<tr>
			<td colspan="2" align="right">
				<button onclick="table_filter.clearParameters('bestellung');">Alles zurücksetzen</button>
				<button onclick="table_filter.setParameters('bestellung');">Filter anwenden</button>
			</td>
		</tr>
	</table>
</fieldset>
