...
<div style="float:left; width:49%; padding-right:1%;">
    ...
    <table style="font-size: 8pt; background: white; color: #333333; border-collapse: collapse;" width="100%" cellspacing="10" cellpadding="10">
        <tr>
            ...
            <td class="auftraginfo_cell" colspan="2">
                <b>{|Zahlung|}</b>
            </td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Kunde|}:</td>
            <td class="auftraginfo_cell">[KUNDE]</td>
            <td class="auftraginfo_cell" width="25%">{|Zahlweise|}:</td>
            <td class="auftraginfo_cell">[ZAHLWEISE]</td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Status|}:</td>
            <td class="auftraginfo_cell">[STATUS]</td>
            <td class="auftraginfo_cell">{|Wunschlieferdatum|}:</td>
            <td class="auftraginfo_cell">[WUNSCHLIEFERDATUM]</td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Projekt:|}</td>
            <td class="auftraginfo_cell">[PROJEKT]</td>
            <td class="auftraginfo_cell">{|Kundensaldo|}:</td>
            <td class="auftraginfo_cell">[KUNDENSALDO]</td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Onlineshop|}:</td>
            <td class="auftraginfo_cell">[ONLINESHOP]</td>
            <td class="auftraginfo_cell">{|Besteuerung|}:</td>
            <td class="auftraginfo_cell">[STEUER]</td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Internet|}:</td>
            <td class="auftraginfo_cell">[INTERNET]</td>
            <td class="auftraginfo_cell">{|Eigene Umsatzsteuer ID|}:</td>
            <td class="auftraginfo_cell">[DELIVERYTHRESHOLDVATID]</td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Ihre Bestellnummer|}:</td>
            <td class="auftraginfo_cell">[IHREBESTELLNUMMER]</td>
            <td class="auftraginfo_cell"></td>
            <td class="auftraginfo_cell"></td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Transaktion|}:</td>
            <td class="auftraginfo_cell">[TRANSAKTIONSNUMMER]</td>
            <td class="auftraginfo_cell"></td>
            <td class="auftraginfo_cell"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auftraginfo_cell">{|Angebot|}:</td>
            <td class="auftraginfo_cell">[ANGEBOT]</td>
            <td class="auftraginfo_cell">{|Versandart|}:</td>
            <td class="auftraginfo_cell">[VERSANDART]</td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Lieferschein|}:</td>
            <td class="auftraginfo_cell">[LIEFERSCHEIN]</td>
            <td class="auftraginfo_cell">{|Gewicht (netto)|}:</td>
            <td class="auftraginfo_cell">[GEWICHT]</td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Rechnung|}:</td>
            <td class="auftraginfo_cell">[RECHNUNG]</td>
            <td class="auftraginfo_cell">{|Pakete|}:</td>
            <td class="auftraginfo_cell">[TRACKING]</td>
        </tr>
        [PRODUKTIONEN] 
        <tr>
            <td class="auftraginfo_cell">{|Gutschrift|}:</td>
            <td class="auftraginfo_cell">[GUTSCHRIFT]</td>
            <td class="auftraginfo_cell"></td>
            <td class="auftraginfo_cell"></td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Preisanfrage|}:</td>
            <td class="auftraginfo_cell">[PREISANFRAGE]</td>
            <td class="auftraginfo_cell"></td>
            <td class="auftraginfo_cell"></td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Bestellung|}:</td>
            <td class="auftraginfo_cell">[BESTELLUNG]</td>
            <td class="auftraginfo_cell"></td>
            <td class="auftraginfo_cell"></td>
        </tr>
        <tr>
            <td class="auftraginfo_cell">{|Retoure|}:</td>
            <td class="auftraginfo_cell">[RETOURE]</td>
            <td class="auftraginfo_cell"></td>
            <td class="auftraginfo_cell"></td>
        </tr>
