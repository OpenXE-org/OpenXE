...
<fieldset><legend>{|Inhalt|}</legend>
    <table width="100%">
          <tr><td width="150" valign="top">Betreff:</td><td><input type="text" name="title" value="[TITLE]" style="width: 600px"><br></td></tr>
          <tr><td valign="top">Text:</td><td><textarea rows="20" id="html" name="html" style="width: 612px">[LANGTEXT]</textarea></td></tr>
</table></fieldset>
    ...
    <input type="submit" name="inhalt_submit" name="inhalt_submit" value="Speichern"/>
    </tr>
