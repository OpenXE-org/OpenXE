<fieldset data-filter="rechnung" class="table_filter" style="display:none">
	...
	<table width="100%">
			...
			<td valign="top">
				...
				<div class="table_filter_container table_filter_container_right">
					<table width="100%">
						...
						<tr>
							<td>Belegnummer:</td>
							<td><input type="text" name="belegnummer" value="" id="rechnungsnummer"></td>
						</tr>
						<tr>
							<td>Freitext:</td>
		...
		<tr>
			<td colspan="2" align="right">
				<button onclick="table_filter.clearParameters('rechnung');">Alles zurücksetzen</button>
				<button onclick="table_filter.setParameters('rechnung');">Filter anwenden</button>
			</td>
		</tr>
	</table>
</fieldset>
