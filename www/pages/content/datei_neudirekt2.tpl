				...
				<tr>
					<td>
						<form action="" method="post" name="eprooform" enctype="multipart/form-data">
	    					...
	    					<tr id="trdatei" class="stddownload">
	    						<td nowrap>{|Datei|}:</td>
	    						<td colspan="3"><input type="file" name="upload" style="min-width: 230px;max-width:250px;"></td>
	    					</tr>
								[STARTDISABLE]
...
-->
    						<tr valign="" height="" bgcolor="" align="" bordercolor="" class="klein" classname="klein">
    							<td width="" valign="" height="" bgcolor="" align="right" colspan="4" bordercolor="" classname="orange2" class="orange2">
    								...
    								value="{|Speichern|}" /> <input type="button" onclick="window.parent.$('#dateipopupiframediv').dialog('close');" value="{|Abbrechen|}" /></td>
    						</tr>
  						</table>
...
#upload-button a:hover {
	box-shadow: 0 0 500px 62px rgba(255, 255, 255, 1), inset 0 -5px 40px 0px #0A9FCA;
}
    ...
    buttons: {
      ...
      '{|SPEICHERN|}': function()
      {
          ...
          $.ajax({
              ...
              type: 'POST',
              dataType: 'json',
              data: { id: $('#editid').val(),subjekt:$('#editsubjekt').val(), typ:$('#edittyp').val(),titel:$('#edittitel').val(), beschreibung:$('#editbeschreibung').val(), parameter:[ID]},
