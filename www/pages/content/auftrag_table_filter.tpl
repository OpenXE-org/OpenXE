<fieldset data-filter="auftrag" class="table_filter" style="display:none">
	...
	<table width="100%">
			...
			<td valign="top">
				...
				<div class="table_filter_container table_filter_container_right">
					<table width="100%">
						...
						<tr>
							<td>Belegnummer:</td>
							<td><input type="text" name="belegnummer" value="" id="auftragsnummer"></td>
						</tr>
						<tr>
							<td>Freitext:</td>
						...
						<tr>
							...
							<td><input type="text" name="transaktionsnummer" value=""></td>
						</tr>
						<tr>
							<td>Zahlungsweise:</td>
							<td>
						...
						<tr>
							<td>Gruppe:</td>
							<td><input type="text" name="kundengruppe" value="" id="kundengruppe"></td>
						</tr>
					</table>
				</div>
		...
		<tr>
			<td colspan="2" align="right">
				<button onclick="table_filter.clearParameters('auftrag');">Alles zurücksetzen</button>
				<button onclick="table_filter.setParameters('auftrag');">Filter anwenden</button>
			</td>
		</tr>
	</table>
</fieldset>
