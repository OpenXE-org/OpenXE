  ...
  <table class="tableborder" border="0" cellpadding="3" cellspacing="0" width="100%">
    <tbody>
      <tr classname="orange1" class="orange1" bordercolor="" align="" bgcolor="" height="" valign="">
        <td colspan="4" bordercolor="" class="" align="" bgcolor="" height="" valign="">[VERSANDHEADING]<br></td>
      </tr>
...
<table width="100%"><tr><td><input type="button" value="Abbrechen" /></td><td align="right">
    <input type="submit" name=""
            value="Speichern" />
    <input type="submit" name="weiter"
            value="weiter" /></td></tr></table></td>
    </tr>
