...
class WidgetGenspedition
{
  ...
  public function speditionDelete()
  {
    
    $this->form->Execute("spedition","delete");
  ...
  function Form()
  {
    $this->form = $this->app->FormHandler->CreateNew("spedition");
    $this->form->UseTable("spedition");
    $this->form->UseTemplate("spedition.tpl",$this->parsetarget);
