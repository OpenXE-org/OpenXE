...
class WidgetGenproformarechnung_position
{
  ...
  public function proformarechnung_positionDelete()
  {
    
    $this->form->Execute("proformarechnung_position","delete");

    $this->proformarechnung_positionList();
  }
  ...
  function Form()
  {
    $this->form = $this->app->FormHandler->CreateNew("proformarechnung_position");
    $this->form->UseTable("proformarechnung_position");
    $this->form->UseTemplate("proformarechnung_position.tpl",$this->parsetarget);
