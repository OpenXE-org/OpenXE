...
class WidgetGenspedition_avi
{
  ...
  public function spedition_aviDelete()
  {
    
    $this->form->Execute("spedition_avi","delete");

    $this->spedition_aviList();
  }
  ...
  function Form()
  {
    $this->form = $this->app->FormHandler->CreateNew("spedition_avi");
    $this->form->UseTable("spedition_avi");
    $this->form->UseTemplate("spedition_avi.tpl",$this->parsetarget);
    ...
    $field = new HTMLInput("spedition_avibestaetigtabnummer","text","","30","","","","","","","","0","","");
    $this->form->NewField($field);
