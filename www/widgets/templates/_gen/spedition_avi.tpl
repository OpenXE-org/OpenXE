...
<tr> 
<td width="33%"></td> 
<td align="center"><b style="font-size: 14pt">Spedition AVI <font color="blue">[NUMMER]</font></b>[LIEFERANT]</td> 
...
<table class="mkTableFormular">
  <tr><td><legend>{|Lieferant|}</legend></td><td>[ADRESSE][MSGADRESSE]&nbsp;
[BUTTON_UEBERNEHMEN]
</td></tr>
...
<fieldset class="turkey"><legend>{|Abweichende Lieferadresse|}</legend>
  <table class="tableabweichend" style="background-color:#c2e3ea;">
