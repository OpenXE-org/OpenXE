  ...
  $('#positionaccordion').accordion({
    ...
    create: function( event, ui ) {
      ...
      if($(h3s).length > 0)
      {
        ...
        $.ajax({
          url: 'index.php?module=auftrag&action=positioneneditpopup&cmd=getopenaccordions',
          type: 'POST',
          dataType: 'json',
          ...
          success: function (data) {
            ...
            $('#positionaccordion h3').on('click',function()
            {
              ...
              $.ajax({
                url: 'index.php?module=auftrag&action=positioneneditpopup&cmd=setaccordion',
                type: 'POST',
                dataType: 'json',
...
[DISPLAY_AUFTRAG_POSITION_HOOK1]
 ...
 <table class="tableborder" border="0" cellpadding="3" cellspacing="0" width="100%">
    <tbody>
      ...
      <tr valign="top">
        ...
        <tr id="trbeschreibung"><td>{|Beschreibung|}:</td><td>[BESCHREIBUNG][MSGBESCHREIBUNG]</td></tr>
	      <tr><td>{|Menge|}:</td><td>[MENGE][MSGMENGE][MENGEBUTTON]</td></tr>
