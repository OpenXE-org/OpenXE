      ...
      <tr valign="top">
        <td width="550">
          <table border="0" style="padding-right:10px;" class="mkTableFormular">
            <tbody>
              ...
              <tr><td>Art-Nr. bei Kunde:</td><td>[ARTIKELNUMMERKUNDE][MSGARTIKELNUMMERKUNDE]</td></tr>
              <tr><td>{|Im PDF ausblenden|}:</td><td>[AUSBLENDEN_IM_PDF][MSGAUSBLENDEN_IM_PDF]</td></tr>
              <tr><td>{|Als kostenlos markieren|}:</td><td>[KOSTENLOS][MSGKOSTENLOS]</td></tr>

              <tr><td><strong>{|Zollinformationen|}</strong></td><td></td></tr>
              ...
              <tr><td>{|Einzelwert|}:</td><td>[ZOLLEINZELWERT][MSGZOLLEINZELWERT]</td></tr>
              <tr><td>{|Gesamtwert|}:</td><td>[ZOLLGESAMTWERT][MSGZOLLGESAMTWERT]</td></tr>
              <tr><td>{|Währung|}:</td><td>[ZOLLWAEHRUNG][MSGZOLLWAEHRUNG]</td></tr>
              <tr><td>{|Einzelgewicht|}:</td><td>[ZOLLEINZELGEWICHT][MSGZOLLEINZELGEWICHT]</td></tr>
              <tr><td>{|Gesamtgewicht|}:</td><td>[ZOLLGESAMTGEWICHT][MSGZOLLGESAMTGEWICHT]</td></tr>

              <tr><td><strong>{|Logistik|}</strong></td><td></td></tr>
              <tr><td>{|Manuelle NVE|}:</td><td>[NVE][MSGNVE]</td></tr>
              <tr><td>{|Packst&uuml;ck|}:</td><td>[PACKSTUECK][MSGPACKSTUECK]</td></tr>
              <tr><td>{|Anzahl VPE|}:</td><td>[VPEMENGE][MSGVPEMENGE]</td></tr>
              <tr><td>{|Anzahl Einzelstück|}:</td><td>[EINZELSTUECKMENGE][MSGEINZELSTUECKMENGE]</td></tr>
        ...
        <td>
            <table width="100%"><tr><td align="right"><input type="submit" value="Speichern" ></td></tr></table>
              <table><tr><td>Bemerkung:<br>[BEMERKUNG][MSGBEMERKUNG]</td></tr></table>
[INPUT1][MSGINPUT1]
        </td>
      </tr>
    </tbody>
