...
<tr>
<td>&nbsp;<b style="font-size: 14pt">Anfrage <font color="blue">[NUMMER]</font></b>[KUNDE][RABATTANZEIGE]</td>
<td>[STATUSICONS]</td>
...
<tr>
<td width="33%"></td>
<td align="center"><b style="font-size: 14pt">{|Anfrage|} <font color="blue">[NUMMER]</font></b>[KUNDE][RABATTANZEIGE]</td>
