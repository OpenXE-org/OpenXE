  ...
  $('#positionaccordion').accordion({
    ...
    create: function( event, ui ) {
      ...
      if($(h3s).length > 0)
      {
        ...
        $.ajax({
          url: 'index.php?module=angebot&action=positioneneditpopup&cmd=getopenaccordions',
          type: 'POST',
          dataType: 'json',
          ...
          success: function (data) {
            ...
            $('#positionaccordion h3').on('click',function()
            {
              ...
              $.ajax({
                url: 'index.php?module=angebot&action=positioneneditpopup&cmd=setaccordion',
                type: 'POST',
                dataType: 'json',
...
<tr><td>{|Optional|}:</td><td>[OPTIONAL][MSGOPTIONAL]&nbsp;<i>({|nicht in Gesamtsumme|})</i></td></tr>
         ...
         <tr><td>{|Alternativ Text Preis|}:</td><td>[TEXTALTERNATIVPREIS][MSGTEXTALTERNATIVPREIS]</td></tr>
              
        [VORPREISBERECHNEN]<tr><td>{|Preis berechnen aus Teile|}:</td><td>[BERECHNEN_AUS_TEILE][MSGBERECHNEN_AUS_TEILE]&nbsp;<i>({|Bei St&uuml;cklisten|})</i></td></tr>[NACHPREISBERECHNEN]
        <tr><td>{|Im PDF ausblenden|}:</td><td>[AUSBLENDEN_IM_PDF][MSGAUSBLENDEN_IM_PDF]</td></tr>
        <tr><td>{|Geh&ouml;rt zu|}:</td><td>[EXPLODIERT_PARENT][MSGEXPLODIERT_PARENT]</td></tr>
