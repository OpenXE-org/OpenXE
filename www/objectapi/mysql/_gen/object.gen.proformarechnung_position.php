...
class ObjGenProformarechnung_Position
{

  private  $id;
  private  $proformarechnung;
  private  $artikel;
  private  $projekt;
  private  $bezeichnung;
  ...
  {
    if(is_numeric($id))
      $result = $this->app->DB->SelectArr("SELECT * FROM proformarechnung_position WHERE (id = '$id')");
    else
      return -1;
...
$result = $result[0];
    ...
    $this->id=$result['id'];
    $this->proformarechnung=$result['proformarechnung'];
  ...
  {
    $sql = "INSERT INTO proformarechnung_position (id,proformarechnung,artikel,projekt,bezeichnung,beschreibung,internerkommentar,nummer,menge,preis,waehrung,lieferdatum,vpe,sort,status,umsatzsteuer,bemerkung,logdatei,explodiert_parent_artikel,keinrabatterlaubt,punkte,bonuspunkte,mlmdirektpraemie,mlm_abgerechnet,grundrabatt,rabattsync,rabatt1,rabatt2,rabatt3,rabatt4,rabatt5,einheit,rabatt,zolltarifnummer,herkunftsland,artikelnummerkunde,lieferdatumkw,auftrag_position_id,teilprojekt,freifeld1,freifeld2,freifeld3,freifeld4,freifeld5,freifeld6,freifeld7,freifeld8,freifeld9,freifeld10,steuersatz,steuertext,erloese,erloesefestschreiben,freifeld11,freifeld12,freifeld13,freifeld14,freifeld15,freifeld16,freifeld17,freifeld18,freifeld19,freifeld20,formelmenge,formelpreis,geliefert,freifeld21,freifeld22,freifeld23,freifeld24,freifeld25,freifeld26,freifeld27,freifeld28,freifeld29,freifeld30,freifeld31,freifeld32,freifeld33,freifeld34,freifeld35,freifeld36,freifeld37,freifeld38,freifeld39,freifeld40,kostenstelle)
      VALUES('','{$this->proformarechnung}','{$this->artikel}','{$this->projekt}','{$this->bezeichnung}','{$this->beschreibung}','{$this->internerkommentar}','{$this->nummer}','{$this->menge}','{$this->preis}','{$this->waehrung}','{$this->lieferdatum}','{$this->vpe}','{$this->sort}','{$this->status}','{$this->umsatzsteuer}','{$this->bemerkung}','{$this->logdatei}','{$this->explodiert_parent_artikel}','{$this->keinrabatterlaubt}','{$this->punkte}','{$this->bonuspunkte}','{$this->mlmdirektpraemie}','{$this->mlm_abgerechnet}','{$this->grundrabatt}','{$this->rabattsync}','{$this->rabatt1}','{$this->rabatt2}','{$this->rabatt3}','{$this->rabatt4}','{$this->rabatt5}','{$this->einheit}','{$this->rabatt}','{$this->zolltarifnummer}','{$this->herkunftsland}','{$this->artikelnummerkunde}','{$this->lieferdatumkw}','{$this->auftrag_position_id}','{$this->teilprojekt}','{$this->freifeld1}','{$this->freifeld2}','{$this->freifeld3}','{$this->freifeld4}','{$this->freifeld5}','{$this->freifeld6}','{$this->freifeld7}','{$this->freifeld8}','{$this->freifeld9}','{$this->freifeld10}','{$this->steuersatz}','{$this->steuertext}','{$this->erloese}','{$this->erloesefestschreiben}','{$this->freifeld11}','{$this->freifeld12}','{$this->freifeld13}','{$this->freifeld14}','{$this->freifeld15}','{$this->freifeld16}','{$this->freifeld17}','{$this->freifeld18}','{$this->freifeld19}','{$this->freifeld20}','{$this->formelmenge}','{$this->formelpreis}','{$this->geliefert}','{$this->freifeld21}','{$this->freifeld22}','{$this->freifeld23}','{$this->freifeld24}','{$this->freifeld25}','{$this->freifeld26}','{$this->freifeld27}','{$this->freifeld28}','{$this->freifeld29}','{$this->freifeld30}','{$this->freifeld31}','{$this->freifeld32}','{$this->freifeld33}','{$this->freifeld34}','{$this->freifeld35}','{$this->freifeld36}','{$this->freifeld37}','{$this->freifeld38}','{$this->freifeld39}','{$this->freifeld40}','{$this->kostenstelle}')"; 
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE proformarechnung_position SET
      proformarechnung='{$this->proformarechnung}',
  ...
  public function Delete($id="")
  {
    ...
    $sql = "DELETE FROM proformarechnung_position WHERE (id='{$this->id}')";
    $this->app->DB->Delete($sql);

    $this->id="";
    $this->proformarechnung="";
    $this->artikel="";
    $this->projekt="";
    $this->bezeichnung="";
    $this->beschreibung="";
 ...
 /** dank dieser funktionen kann man die tatsaechlichen werte einfach 
  ...
  function SetProformarechnung($value) { $this->proformarechnung=$value; }
  function GetProformarechnung() { return $this->proformarechnung; }
