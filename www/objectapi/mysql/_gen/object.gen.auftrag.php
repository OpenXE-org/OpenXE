...
$result = $result[0];
    ...
    $this->nicht_reservieren=$result['nicht_reservieren'];
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE `auftrag` SET
      ...
      `nicht_reservieren`='{$this->nicht_reservieren}',
 ...
 /** dank dieser funktionen kann man die tatsaechlichen werte einfach 
  ...
  public function SetNicht_reservieren($value) { $this->nicht_reservieren=$value; }
  public function GetNicht_reservieren() { return $this->nicht_reservieren; }
