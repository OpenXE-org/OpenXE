...
class ObjGenAdresse
{
  ...
  private  $kennung;
  private  $sachkonto;
  private  $rechnung_smarty_template;
  private  $freifeld1;
  private  $freifeld2;
  private  $freifeld3;
  private  $filiale;
  ...
  private  $rechnung_anzahlpapier_abweichend;
...
$result = $result[0];
    ...
    $this->sachkonto=$result['kontorahmen'];
    $this->rechnung_smarty_template=$result['rechnung_smarty_template'];
    ...
    $this->rechnung_anzahlpapier_abweichend=$result['rechnung_anzahlpapier_abweichend'];
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE `adresse` SET
      ...
      `kontorahmen`='{$this->sachkonto}',
      `rechnung_smarty_template`='{$this->rechnung_smarty_template}',
      ...
      `rechnung_anzahlpapier_abweichend`='{$this->rechnung_anzahlpapier_abweichend}',
  ...
  public function Delete($id='')
  {
    ...
    $this->rechnung_anzahlpapier_abweichend='';
 ...
 /** dank dieser funktionen kann man die tatsaechlichen werte einfach 
  ...
  public function SetRechnung_smarty_template($value) { $this->rechnung_smarty_template=$value; }
  public function GetRechnung_smarty_template() { return $this->rechnung_smarty_template; }
  ...
  public function SetRechnung_Anzahlpapier_Abweichend($value) { $this->rechnung_anzahlpapier_abweichend=$value; }
  public function GetRechnung_Anzahlpapier_Abweichend() { return $this->rechnung_anzahlpapier_abweichend; }
