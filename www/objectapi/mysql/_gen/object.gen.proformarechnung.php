...
class ObjGenProformarechnung
{
  ...
  private  $liefertitel;
  private  $liefergln;
  private  $zollinformation;
  private  $verzollungadresse;
  private  $verzollinformationen;
  private  $verzollungname;
  private  $verzollungabteilung;
  private  $verzollungunterabteilung;
  private  $verzollungland;
  private  $verzollungstrasse;
  private  $verzollungort;
  private  $verzollungplz;
  private  $verzollungadresszusatz;
  private  $verzollungansprechpartner;
  private  $verzollungtitel;
  private  $formelmenge;
  ...
  {
    if(is_numeric($id))
      $result = $this->app->DB->SelectArr("SELECT * FROM `proformarechnung` WHERE (`id` = '$id')");
    else
      return -1;
...
$result = $result[0];
    ...
    $this->zollinformation=$result['zollinformation'];
    $this->verzollungadresse=$result['verzollungadresse'];
    $this->verzollinformationen=$result['verzollinformationen'];
    $this->verzollungname=$result['verzollungname'];
    $this->verzollungabteilung=$result['verzollungabteilung'];
    $this->verzollungunterabteilung=$result['verzollungunterabteilung'];
    $this->verzollungland=$result['verzollungland'];
    $this->verzollungstrasse=$result['verzollungstrasse'];
    $this->verzollungort=$result['verzollungort'];
    $this->verzollungplz=$result['verzollungplz'];
    $this->verzollungadresszusatz=$result['verzollungadresszusatz'];
    $this->verzollungansprechpartner=$result['verzollungansprechpartner'];
    $this->verzollungtitel=$result['verzollungtitel'];
  ...
  public function Update()
  {
    ...
    $sql = "UPDATE `proformarechnung` SET
      `datum`='{$this->datum}',
      ...
      `zollinformation`='{$this->zollinformation}',
      `verzollungadresse`='{$this->verzollungadresse}',
      `verzollinformationen`='{$this->verzollinformationen}',
      `verzollungname`='{$this->verzollungname}',
      `verzollungabteilung`='{$this->verzollungabteilung}',
      `verzollungunterabteilung`='{$this->verzollungunterabteilung}',
      `verzollungland`='{$this->verzollungland}',
      `verzollungstrasse`='{$this->verzollungstrasse}',
      `verzollungort`='{$this->verzollungort}',
      `verzollungplz`='{$this->verzollungplz}',
      `verzollungadresszusatz`='{$this->verzollungadresszusatz}',
      `verzollungansprechpartner`='{$this->verzollungansprechpartner}',
      `verzollungtitel`='{$this->verzollungtitel}',
  ...
  public function Delete($id='')
  {
    ...
    $sql = "DELETE FROM `proformarechnung` WHERE (`id`='{$this->id}')";
    ...
    $this->liefertitel='';
    $this->liefergln='';
    $this->zollinformation='';
    $this->verzollungadresse='';
    $this->verzollinformationen='';
    $this->verzollungname='';
    $this->verzollungabteilung='';
    $this->verzollungunterabteilung='';
    $this->verzollungland='';
    $this->verzollungstrasse='';
    $this->verzollungort='';
    $this->verzollungplz='';
    $this->verzollungadresszusatz='';
    $this->verzollungansprechpartner='';
    $this->verzollungtitel='';
    $this->formelmenge='';
    $this->anzeigesteuer='';
    $this->bundesstaat='';
 ...
 /** dank dieser funktionen kann man die tatsaechlichen werte einfach 
  ...
  public function SetZollinformation($value) { $this->zollinformation=$value; }
  public function GetZollinformation() { return $this->zollinformation; }
  public function SetVerzollungadresse($value) { $this->verzollungadresse=$value; }
  public function GetVerzollungadresse() { return $this->verzollungadresse; }
  public function SetVerzollinformationen($value) { $this->verzollinformationen=$value; }
  public function GetVerzollinformationen() { return $this->verzollinformationen; }
  public function SetVerzollungname($value) { $this->verzollungname=$value; }
  public function GetVerzollungname() { return $this->verzollungname; }
  public function SetVerzollungabteilung($value) { $this->verzollungabteilung=$value; }
  public function GetVerzollungabteilung() { return $this->verzollungabteilung; }
  public function SetVerzollungunterabteilung($value) { $this->verzollungunterabteilung=$value; }
  public function GetVerzollungunterabteilung() { return $this->verzollungunterabteilung; }
  public function SetVerzollungland($value) { $this->verzollungland=$value; }
  public function GetVerzollungland() { return $this->verzollungland; }
  public function SetVerzollungstrasse($value) { $this->verzollungstrasse=$value; }
  public function GetVerzollungstrasse() { return $this->verzollungstrasse; }
  public function SetVerzollungort($value) { $this->verzollungort=$value; }
  public function GetVerzollungort() { return $this->verzollungort; }
  public function SetVerzollungplz($value) { $this->verzollungplz=$value; }
  public function GetVerzollungplz() { return $this->verzollungplz; }
  public function SetVerzollungadresszusatz($value) { $this->verzollungadresszusatz=$value; }
  public function GetVerzollungadresszusatz() { return $this->verzollungadresszusatz; }
  public function SetVerzollungansprechpartner($value) { $this->verzollungansprechpartner=$value; }
  public function GetVerzollungansprechpartner() { return $this->verzollungansprechpartner; }
  public function SetVerzollungtitel($value) { $this->verzollungtitel=$value; }
  public function GetVerzollungtitel() { return $this->verzollungtitel; }
